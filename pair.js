        ...
        try {
            ...
            SUPUNMDInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'SANIJA-MD=' + stringSession;  // Prepend your name to the session ID
                    ...
                    await SUPUNMDInc.sendMessage(userJid, { text: "*🪄 SANIJA MD New Update.....💐*\n\n* SESION SUCCESSFUL ✅\n\n*උඩ ආපු Sesion Id එක ශෙයා කරන්න එපා හොදද 😩🪄💐*\n\n+ ┉┉┉┉┉┉┉┉[ ❤️‍🩹 ]┉┉┉┉┉┉┉┉ +\n*❗𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐆𝐑𝐎𝐔𝐏*\n* none\n\n*❗𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍𝐄𝐋*\n* https://whatsapp.com/channel/\n\n*❗SANIJA 𝐂𝐎𝐍𝐓𝐀𝐂𝐓*\n* wa.me/94771343579\n\n\n> 𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 SANIJA MD 𝙾𝙵𝙲 🫟" });
